...
public class HashMapExample {
    ...
    public static void main(String[] args) {
        ...
        containsKeyMethodExample(myMap,"Anna");
        containsValueMethodExample(myMap, 34);
        containsValueMethodExample(myMap, 365);
    ...
    static void containsKeyMethodExample(Map<String, Integer> someMap, String mapKey) {
        System.out.println("Is map contains " + mapKey + "? - " + someMap.containsKey(mapKey));
    }

    static void containsValueMethodExample(Map<String, Integer> someMap, Integer mapValue) {
        System.out.println("Is map contains " + mapValue + "? - " + someMap.containsValue(mapValue));
    }
